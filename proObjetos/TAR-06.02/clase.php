    ...
    class Fechas{
        ...
        private function calcularBisiesto($ano){
            if($ano % 4 == 0 && ($ano % 100 != 0 || $ano % 400 == 0)){
                $this->meses_dias[2]['dias']=29;
            }
            $this->meses_dias[2]['dias']=28;
        }
        public function generarFecha(){
            $this->calcularBisiesto($this->fecha[0]);
            $this->febrero = $this->meses_dias['02']['dias'];
            if($this->meses_dias['02']['dias'] < $this->fecha[2] && $this->fecha[1] == 2){
